...
{
    /// <inheritdoc />
    public partial class AddModel_Votes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionFavorites", x => x.FavId);
                    table.ForeignKey(
                        name: "FK_QuestionFavorites_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "QuestionId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuestionFavorites_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionFavorites_QuestionId",
                table: "QuestionFavorites",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionFavorites_UserId",
                table: "QuestionFavorites",
                column: "UserId");
